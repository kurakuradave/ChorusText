/* Socket.IO */
var CTSocket = require( './controllers/CTSocket.js' );
var CTServer = {}; // placeholder, to be linked from bin/www
var io = {}; // placeholder

/* Session Manager */
var SessionManager = require( './controllers/SessionManager.js' );
