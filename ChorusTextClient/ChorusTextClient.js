...
socketClient.on('connect', function( data ) { 
     console.log( "ChorusText device connected to server via socket! " + data.msg );
});
                ...
                if( data.indexOf( "{" ) == 0 ) {
                    ...
                    if( obj.hasOwnProperty( 't' ) ) { // turn
                        ...
                        switch( cFocus ) {
                            ...
                            case 1 :
                                cs.sys_say( "location" );
                                // test connecting to server via socket
                                socketClient.emit( 'connect', { "ccdocuID" : "testdocu", "userID" : "CT0079" } );
                            break;
                            case 2 :
                                cs.sys_say( "main" );
                            break;
